...
<template>
  <div class="classify-list">
    <div class="list-item" :class="{'list-item-selected': router.currentRoute.value.params.id === item.id}" @click="showFiles(item)" v-for="item in props.classifyData" :key="item.id">
        <div class="item-img">
...
<style scoped lang="scss">
  .classify-list{
    ...
    .list-item:last-child{ margin-bottom: 15Px; }
