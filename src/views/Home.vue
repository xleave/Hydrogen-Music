    ...
    <main>
      <div class="home-header">
        <div class="header-router">
          <router-link class="button-music" to="/mymusic"></router-link>
        </div>
        <div class="user">
...
.home-header {
  ...
  .user {
    ...
    .app-option {
      padding: 0; width: 100px; height: 0; background-image: url('../assets/img/halftone.png'); background-size: 120%; background-color: #141414; overflow: hidden; position: absolute; top: 35px; right: 0; left: auto;
