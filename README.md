...
Hydrogen Music 是由 **xleave** 维护的本地桌面音乐播放器，当前版本为 **0.8.0**。应用使用 Vue 3 保留既有播放器视觉风格，以 Tauri 2 和 Rust 提供本地目录扫描、原生音频播放、音频元数据读取、封面与歌词加载、MPRIS 系统媒体控制、设置保存和桌面打包能力。
